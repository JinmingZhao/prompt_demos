...
do
    CUDA_VISIBLE_DEVICES=${gpuid} python run_mask.py \
        ...
        --do_train --do_eval \
        --train_file ${data_dir}/${cvNo}/trn_val_mask_heis.csv \
        --validation_file ${data_dir}/${cvNo}/tst_mask_heis.csv \
        --max_seq_length 50 \
        ...
        --output_dir ${result_dir}/bert_prompt_heis_base_uncased_2e5_epoch10_bs32_trnval/${cvNo}
done