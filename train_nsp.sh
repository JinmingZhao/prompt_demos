...
do
    CUDA_VISIBLE_DEVICES=${gpuid} python run_nsp.py \
        ...
        --do_train --do_eval \
        --train_file ${data_dir}/${cvNo}/trn_val_nsp_heis.csv \
        --validation_file ${data_dir}/${cvNo}/tst_nsp_heis.csv \
        --max_seq_length 50 \
        ...
        --output_dir ${result_dir}/bert_prompt_nsp_heis_base_uncased_2e5_epoch10_bs32_trnval/${cvNo}
done